...
// UpdateNetworkApplianceVlanRequestDhcpOptionsInner struct for UpdateNetworkApplianceVlanRequestDhcpOptionsInner
type UpdateNetworkApplianceVlanRequestDhcpOptionsInner struct {
...
func NewUpdateNetworkApplianceVlanRequestDhcpOptionsInner(code string, type_ string, value string) *UpdateNetworkApplianceVlanRequestDhcpOptionsInner {
	this := UpdateNetworkApplianceVlanRequestDhcpOptionsInner{}
	this.Code = code
	this.Type = type_
	this.Value = value
	return &this
...
func (o UpdateNetworkApplianceVlanRequestDhcpOptionsInner) MarshalJSON() ([]byte, error) {
...
type NullableUpdateNetworkApplianceVlanRequestDhcpOptionsInner struct {
	value *UpdateNetworkApplianceVlanRequestDhcpOptionsInner
	isSet bool
}

func (v NullableUpdateNetworkApplianceVlanRequestDhcpOptionsInner) Get() *UpdateNetworkApplianceVlanRequestDhcpOptionsInner {
	return v.value
}

func (v *NullableUpdateNetworkApplianceVlanRequestDhcpOptionsInner) Set(val *UpdateNetworkApplianceVlanRequestDhcpOptionsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateNetworkApplianceVlanRequestDhcpOptionsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateNetworkApplianceVlanRequestDhcpOptionsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateNetworkApplianceVlanRequestDhcpOptionsInner(val *UpdateNetworkApplianceVlanRequestDhcpOptionsInner) *NullableUpdateNetworkApplianceVlanRequestDhcpOptionsInner {
	return &NullableUpdateNetworkApplianceVlanRequestDhcpOptionsInner{value: val, isSet: true}
}

func (v NullableUpdateNetworkApplianceVlanRequestDhcpOptionsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateNetworkApplianceVlanRequestDhcpOptionsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
