...
func (r SamlRolesApiUpdateOrganizationSamlRoleRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *SamlRolesApiService) UpdateOrganizationSamlRoleExecute(r SamlRolesApiUpdateOrganizationSamlRoleRequest) (map[string]interface{}, *http.Response, error) {
	var (
