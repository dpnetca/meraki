...
`func NewUpdateNetworkApplianceVpnBgpRequestNeighborsInner(ip string, remoteAsNumber int32, ebgpHoldTimer int32, ebgpMultihop int32, ) *UpdateNetworkApplianceVpnBgpRequestNeighborsInner`
