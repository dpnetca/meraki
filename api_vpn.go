...
func (r VpnApiGetNetworkApplianceVpnSiteToSiteVpnRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *VpnApiService) GetNetworkApplianceVpnSiteToSiteVpnExecute(r VpnApiGetNetworkApplianceVpnSiteToSiteVpnRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VpnApiUpdateNetworkApplianceVpnSiteToSiteVpnRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *VpnApiService) UpdateNetworkApplianceVpnSiteToSiteVpnExecute(r VpnApiUpdateNetworkApplianceVpnSiteToSiteVpnRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
