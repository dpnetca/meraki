...
// checks if the UpdateNetworkWirelessSsidRequestDot11w type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateNetworkWirelessSsidRequestDot11w{}
...
func (o UpdateNetworkWirelessSsidRequestDot11w) ToMap() (map[string]interface{}, error) {
