...
func (a *MonitorApiService) GetNetworkClientsExecute(r MonitorApiGetNetworkClientsRequest) (*GetNetworkClients200Response, *http.Response, error) {
	...
	if r.recentDeviceConnections != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "recentDeviceConnections", r.recentDeviceConnections, "csv")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (a *MonitorApiService) GetNetworkEventsExecute(r MonitorApiGetNetworkEventsRequest) (*GetNetworkEvents200Response, *http.Response, error) {
	...
	if r.includedEventTypes != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includedEventTypes", r.includedEventTypes, "csv")
	}
	if r.excludedEventTypes != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "excludedEventTypes", r.excludedEventTypes, "csv")
	}
	if r.deviceMac != nil {
...
func (a *MonitorApiService) GetNetworkWirelessClientConnectivityEventsExecute(r MonitorApiGetNetworkWirelessClientConnectivityEventsRequest) ([]map[string]interface{}, *http.Response, error) {
	...
	if r.includedSeverities != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includedSeverities", r.includedSeverities, "csv")
	}
	if r.band != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "band", r.band, "")
	}
...
func (a *MonitorApiService) GetOrganizationSensorReadingsHistoryExecute(r MonitorApiGetOrganizationSensorReadingsHistoryRequest) ([]GetOrganizationSensorReadingsHistory200ResponseInner, *http.Response, error) {
	...
	if r.metrics != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "metrics", r.metrics, "csv")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
