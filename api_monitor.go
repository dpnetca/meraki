...
func (r MonitorApiGetNetworkInsightApplicationHealthByTimeRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return []map[string]interface{}
func (a *MonitorApiService) GetNetworkInsightApplicationHealthByTimeExecute(r MonitorApiGetNetworkInsightApplicationHealthByTimeRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
