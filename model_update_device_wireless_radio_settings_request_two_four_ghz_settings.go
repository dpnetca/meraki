...
// checks if the UpdateDeviceWirelessRadioSettingsRequestTwoFourGhzSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateDeviceWirelessRadioSettingsRequestTwoFourGhzSettings{}
...
func (o UpdateDeviceWirelessRadioSettingsRequestTwoFourGhzSettings) ToMap() (map[string]interface{}, error) {
