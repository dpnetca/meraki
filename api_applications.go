...
func (r ApplicationsApiGetNetworkInsightApplicationHealthByTimeRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
func (a *ApplicationsApiService) GetNetworkInsightApplicationHealthByTimeExecute(r ApplicationsApiGetNetworkInsightApplicationHealthByTimeRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
...
func (r ApplicationsApiGetOrganizationInsightApplicationsRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return []map[string]interface{}
func (a *ApplicationsApiService) GetOrganizationInsightApplicationsExecute(r ApplicationsApiGetOrganizationInsightApplicationsRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
