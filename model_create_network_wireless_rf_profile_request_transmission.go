...
// checks if the CreateNetworkWirelessRfProfileRequestTransmission type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkWirelessRfProfileRequestTransmission{}
...
func (o CreateNetworkWirelessRfProfileRequestTransmission) ToMap() (map[string]interface{}, error) {
