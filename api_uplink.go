...
type UplinkApiGetOrganizationApplianceUplinkStatusesRequest struct {
	ctx context.Context
	ApiService *UplinkApiService
...
func (r UplinkApiGetOrganizationApplianceUplinkStatusesRequest) PerPage(perPage int32) UplinkApiGetOrganizationApplianceUplinkStatusesRequest {
	r.perPage = &perPage
	return r
}

// A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
func (r UplinkApiGetOrganizationApplianceUplinkStatusesRequest) StartingAfter(startingAfter string) UplinkApiGetOrganizationApplianceUplinkStatusesRequest {
	r.startingAfter = &startingAfter
	return r
}

// A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
func (r UplinkApiGetOrganizationApplianceUplinkStatusesRequest) EndingBefore(endingBefore string) UplinkApiGetOrganizationApplianceUplinkStatusesRequest {
	r.endingBefore = &endingBefore
	return r
}

// A list of network IDs. The returned devices will be filtered to only include these networks.
func (r UplinkApiGetOrganizationApplianceUplinkStatusesRequest) NetworkIds(networkIds []string) UplinkApiGetOrganizationApplianceUplinkStatusesRequest {
	r.networkIds = &networkIds
	return r
}

// A list of serial numbers. The returned devices will be filtered to only include these serials.
func (r UplinkApiGetOrganizationApplianceUplinkStatusesRequest) Serials(serials []string) UplinkApiGetOrganizationApplianceUplinkStatusesRequest {
	r.serials = &serials
	return r
}

// A list of ICCIDs. The returned devices will be filtered to only include these ICCIDs.
func (r UplinkApiGetOrganizationApplianceUplinkStatusesRequest) Iccids(iccids []string) UplinkApiGetOrganizationApplianceUplinkStatusesRequest {
	r.iccids = &iccids
	return r
}

func (r UplinkApiGetOrganizationApplianceUplinkStatusesRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
List the uplink status of every Meraki MX and Z series appliances in the organization
 ...
 @return UplinkApiGetOrganizationApplianceUplinkStatusesRequest
*/
func (a *UplinkApiService) GetOrganizationApplianceUplinkStatuses(ctx context.Context, organizationId string) UplinkApiGetOrganizationApplianceUplinkStatusesRequest {
	return UplinkApiGetOrganizationApplianceUplinkStatusesRequest{
		ApiService: a,
		ctx: ctx,
...
// Execute executes the request
//  @return []map[string]interface{}
func (a *UplinkApiService) GetOrganizationApplianceUplinkStatusesExecute(r UplinkApiGetOrganizationApplianceUplinkStatusesRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
